...
export function ProjectCard({ project, index }: { project: Project; index: number }) {
  return (
    ...
    >
      {/* Image */}
      <div className="relative w-full aspect-video overflow-hidden rounded-t-xl border-b border-zinc-800/40">
        {project.liveUrl ? (
      ...
      {/* Content */}
      <div className="overflow-visible px-4 sm:px-5 py-4 sm:py-5">
        {/* Title row */}
